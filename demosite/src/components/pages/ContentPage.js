    ...
    <div className='page-container'>
      <header>
        ...
        <button className='button'
          onClick={history.goBack}>&larr; BACK </button>
      </header>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Vitae purus
        ...
        vitae sapien pellentesque habitant morb</p>
      <p>Blandit libero volutpat sed cras ornare arcu dui vivamus. Leo urna molestie at elementum eu facilisis sed odio. Lacinia at quis risus sed. Id
        ...
        tincidunt ornare massa. Leo in vitae turpis massa. Suspendisse in est ante in nibh mauris cursus mattis. Mi proin sed libero enim sed</p>
      <p>Quis ipsum suspendisse ultrices gravida dictum fusce ut placerat. In hendrerit gravida rutrum quisque non tellus orci ac auctor. Pellentesque elit
        ...
        Consequat ac felis donec et odio pellentesque diam volutpat commodo. Tortor posuere ac ut consequat.</p>
      <p>Orci porta non pulvinar neque laoreet suspendisse interdum. Nunc scelerisque viverra mauris in aliquam sem. Sit amet facilisis magna etiam
        ...
        ut tellus elementum sagittis vitae et leo duis. Pulvinar proin gravida hendrerit lectus. Massa eget egestas purus viverra accumsan in nisl nisi</p>
      <p>Sodales ut etiam sit amet. Sagittis id consectetur purus ut. Scelerisque eleifend donec pretium vulputate sapien nec sagittis. Sodales ut etiam
        ...
        pellentesque elit ullamcorper dignissim cras. Mauris cursus mattis molestie a iaculis at</p>
    </div>
  )
}
